            ...
            @auth
                ...
                @if (auth()->user()->isAdmin())
                        ...
                        <ul class="pl-7 mt-2 {{ $gradoActivo ? 'block' : 'hidden' }} group-[.selected]:block">
                            <li class="mb-2">
                                <a href="{{ route('grados.index') }}"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-3 {{ request()->routeIs('grados.index') ? 'bg-[#98C560]' : 'bg-gray-400' }}"></span>
                                    Lista de Grados
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="{{ route('grados.create') }}"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-3 {{ request()->routeIs('grados.create') ? 'bg-[#98C560]' : 'bg-gray-400' }}"></span>
                                    Registrar Grado
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="pl-7 mt-2 {{ $seccionActivo ? 'block' : 'hidden' }} group-[.selected]:block">
                            <li class="mb-2">
                                <a href="{{ route('secciones.index') }}"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-3 {{ request()->routeIs('secciones.index') ? 'bg-[#98C560]' : 'bg-gray-400' }}"></span>
                                    Lista de Secciones
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="{{ route('secciones.create') }}"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-3 {{ request()->routeIs('secciones.create') ? 'bg-[#98C560]' : 'bg-gray-400' }}"></span>
                                    Registrar Sección
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="pl-7 mt-2 {{ $asignaturaActivo ? 'block' : 'hidden' }} group-[.selected]:block">
                            <li class="mb-2">
                                <a href="{{ route('asignaturas.index') }}"
                                    ...
                                    <span
                                        class="w-2 h-2 rounded-full mr-3 {{ request()->routeIs('asignaturas.index') ? 'bg-[#98C560]' : 'bg-gray-400' }}"></span>
                    ...
                    <li class="mb-1 group cursor-pointer {{ request()->routeIs(['person', 'users']) ? 'active' : '' }}">
                        ...
                        <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                            ...
                            <li class="mb-4">
                                <a href=" {{ route('asignaturas.asignar.docentes') }}" class="text-sm flex items-center py-2 px-4 rounded-md text-white">
                                    <span
                                        class="w-1.5 h-1.5 rounded-full mr-3 {{ request()->routeIs('users') ? 'bg-[#98C560]' : 'bg-gray-300' }}"></span>
                                   Asignar Docente
                ...
                @elseif(auth()->user()->isDocente())
                    ...
                    <li
                        ...
                        <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                            <li class="mb-4">
                                <a href="{{route('docentes.asignaturas')}}" class="text-sm flex items-center py-2 px-4 rounded-md text-white">
                                    <span
                                        class="w-1.5 h-1.5 rounded-full mr-3 {{ request()->routeIs(['papers.index', 'papers.edit']) ? 'bg-[#98C560]' : 'bg-gray-300' }}"></span>
