        ...
        <form action="{{ route('periodos.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Complete el formulario para agregar un nuevo periodo académico</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-purple-800">
                                ...
                                <p class="text-purple-700">El periodo debe estar dentro del rango de un año escolar. La fecha de fin debe ser posterior a la fecha de inicio.</p>
                            </div>
                        </div>
                    </div>
