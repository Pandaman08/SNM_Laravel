    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Editar Año Escolar</h1>
                    <p class="text-sm text-gray-500 mt-1">Modifique los datos del año escolar seleccionado</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="p-8">
                <form action="{{ route('anios-escolares.update', $anio->id_anio_escolar) }}" method="POST" class="space-y-6" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="relative">
                            ...
                            <textarea
                                ...
                                class="w-full rounded-xl border @error('descripcion') border-red-300 bg-red-50 @else border-gray-200 @enderror 
                                       ...
                                       focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent
                                       transition-all duration-200 hover:border-lime-300"
                            >{{ old('descripcion', $anio->descripcion) }}</textarea>
                        </div>
                        @error('descripcion')
                            <div class="flex items-center gap-2 text-red-600 text-sm mt-2">
                                <i class="ri-error-warning-line"></i>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="fecha_inicio"
                                    name="fecha_inicio"
                                    value="{{ old('fecha_inicio', $anio->fecha_inicio) }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="fecha_fin"
                                    name="fecha_fin"
                                    value="{{ old('fecha_fin', $anio->fecha_fin) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select
                                ...
                                required
                            >
                                <option value="Activo" {{ old('estado', $anio->estado) == 'Activo' ? 'selected' : '' }}>
                                    ✅ Activo
                                </option>
                                <option value="Finalizado" {{ old('estado', $anio->estado) == 'Finalizado' ? 'selected' : '' }}>
                                    ⏸️ Finalizado
                                </option>
                            </select>
                    ...
                    <div class="bg-lime-50 border border-lime-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-lime-800">
                                ...
                                <p class="text-lime-700">ID: <span class="font-semibold">{{ $anio->id_anio_escolar }}</span></p>
                                <p class="text-lime-700">Año actual: <span class="font-semibold">{{ $anio->anio }}</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                        ...
                        >
                            ...
                            <span>Actualizar año escolar</span>
                        </button>
                    </div>
                </form>
            </div>
