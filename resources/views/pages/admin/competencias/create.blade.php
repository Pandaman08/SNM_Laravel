    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Registrar Competencia</h1>
                    <p class="text-sm text-gray-500 mt-1">Complete el formulario para agregar una nueva competencia</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="p-8">
                <form action="{{ route('competencias.store') }}" method="POST" class="space-y-6" novalidate>
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select
                                ...
                                required
                            >
                                <option value="" disabled {{ old('codigo_asignatura') ? '' : 'selected' }}>
                    ...
                    <div class="bg-cyan-50 border border-cyan-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-cyan-800">
                                ...
                                <p class="text-cyan-700">La competencia quedará vinculada a la asignatura seleccionada y podrá ser evaluada en el sistema.</p>
                            </div>
                        </div>
                    </div>
