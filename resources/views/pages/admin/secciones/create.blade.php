...
<div class="min-h-screen py-8 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <div class="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg">
                    <i class="ri-add-box-line text-2xl text-white"></i>
                </div>
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Registrar Sección</h1>
                    <p class="text-sm text-gray-500 mt-1">Complete el formulario para agregar una nueva sección</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="p-8">
                <form action="{{ route('secciones.store') }}" method="POST" class="space-y-6" novalidate>
                    @csrf
                    ...
                    <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-emerald-800">
                                ...
                                <p class="text-emerald-700">Asegúrese de que la sección no esté duplicada para el grado seleccionado.</p>
                            </div>
                        </div>
                    </div>
