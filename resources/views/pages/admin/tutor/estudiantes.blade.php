    ...
    <div class="container mx-auto px-4 py-8">
        ...
        @else
            ...
            <div class="grid gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200/60 hover:shadow-md hover:border-slate-300/60 transition-all duration-300">
                    <div class="p-6">
                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            <!-- Student Info -->
                            <div class="flex items-center gap-4 flex-1">
                                <div class="relative">
                                    <div class="w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 rounded-full flex items-center justify-center">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-slate-800 mb-1">{{ $estudiante['nombre_completo'] }}</h3>
                            ...
                            <div class="flex items-center gap-3 lg:flex-shrink-0">
                                @if($estudiante['codigo_matricula'])
                                    ...
                                    <!-- Dropdown Menu para más opciones (opcional) -->
                                    <div class="relative">
                                        <button class="flex items-center justify-center w-10 h-10 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors duration-200"
                                        ...
                                        <div id="dropdown-{{ $loop->index }}" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-200 z-10">
                                            <div class="py-2">
                                ...
                                @else
                                    <div class="flex items-center gap-2 px-4 py-2.5 bg-amber-50 border border-amber-200 rounded-lg">
                                        ...
                                        <span class="text-sm text-amber-700 font-medium">Sin matrícula activa</span>
                                    </div>
                                @endif
                            </div>
                        </div>
