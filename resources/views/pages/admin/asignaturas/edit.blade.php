...
<div class="max-w-xl mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-gray-100 animate-fade-in">
    ...
    <form action="{{ route('asignaturas.update', $asignatura->codigo_asignatura) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div class="w-full rounded-xl border border-gray-200 bg-gray-50 p-3 text-gray-600 font-medium">
        ...
        <div>
            ...
            <div class="relative">
                <select id="id_grado" name="id_grado"
                        class="w-full rounded-xl border @error('id_grado') border-red-500 @else border-gray-300 @enderror bg-white px-4 py-3 pr-10 shadow-inner
