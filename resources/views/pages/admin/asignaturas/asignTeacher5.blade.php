...
@section('contenido')
                        ...
                        @forelse ($asignaturas as $a)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    ...
                                    @else
                                        <button
                                            onclick="openEditModal('{{ $a->codigo_asignatura }}', '{{ $a->nombre }}')"
            ...
            <div class="mt-4">
                <form id="updateForm" method="POST" action="{{ route('asignaturas.updateAsignacion') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div id="info-container" class="bg-white divide-y divide-gray-200 my-8 space-x-5 flex max-lg:overflow-x-auto">
    ...
    <script>
        ...
        const inputCodigoDocente = document.getElementById('modal_codigo_docente');
        ...
        function renderDocenteInfo(docente) {
            if (!docente || !docente.user || !docente.user.persona) return '';
            return `
        <tr class="hover:bg-gray-50 transition-colors duration-150">
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="h-12 w-12 rounded-full bg-[#2e5382] flex items-center justify-center text-white font-semibold"></div>
                    </div>
                    <div class="ml-4">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    ${docente.jornada_laboral ?? ''} hrs
                </span>
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
                <span class="text-sm text-gray-900">
                    ${docente.departamento_estudios ?? ''}
                </span>
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="space-y-1">
                    <div class="flex items-center text-sm text-gray-900">
                        ...
                        <span class="truncate max-w-xs">${docente.user.email ?? ''}</span>
                    </div>
    ...
    `;
        ...
        inputCodigoDocente.addEventListener('change', function() {
            const selectedDocente = docentes.find(doc => doc.codigo_docente == this.value);
            console.log(docentes);
            console.log(selectedDocente);
            infoContainer.innerHTML = selectedDocente ? renderDocenteInfo(selectedDocente) : '';
        });
