...
<div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow">
    <h1 class="text-2xl font-semibold mb-6 text-gray-800">Registrar asignatura</h1>

    <form action="{{ route('asignaturas.store') }}" method="POST" class="space-y-5">
        @csrf
        <div>
        ...
        <div>
            ...
            <input id="nombre" name="nombre" value="{{ old('nombre') }}" class="w-full border-gray-300 rounded-md shadow-sm mt-1 focus:ring-[#98C560] focus:border-[#98C560]" required>
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button class="px-4 py-2 bg-[#98C560] hover:bg-[#7aa94f] rounded-md text-white text-sm">Guardar</button>
        </div>
    </form>
</div>
@endsection
