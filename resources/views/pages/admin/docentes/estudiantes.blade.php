...
@section('titulo', 'Estudiantes Matriculados')
...
<div class="w-full animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Estudiantes Matriculados</h1>
        ...
        <div class="flex items-center gap-2">
            <span class="badge badge-lg bg-teal-100 text-teal-800 border-teal-200 rounded-3xl p-2">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-medium text-gray-900">{{ $matricula->codigo_matricula }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $matricula->estudiante->persona->name }} {{ $matricula->estudiante->persona->lastname }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center space-x-2">
                            <a href="{{ route('reporte_notas.create', ['codigo_matricula' => $matricula->codigo_matricula, 'id_asignatura' => $asignatura->codigo_asignatura]) }}"
                            ...
                            <a href="{{ route('reporte_notas.show', ['codigo_matricula' => $matricula->codigo_matricula, 'id_asignatura' => $asignatura->codigo_asignatura]) }}"
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-8 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-400">
                                ...
                                <p class="text-lg font-medium">La asignatura {{ $asignatura->nombre }} no tiene estudiantes matriculados</p>
                                <p class="text-sm mt-1">Registra estudiantes para comenzar a agregar calificaciones</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
